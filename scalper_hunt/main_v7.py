                ...
                for asset in brains.keys():
                    ...
                    try:
                        ...
                        if win_prob >= threshold:
                            ...
                            # 🟢 V8.6 Regime-Adaptive Veto Power Check
                            is_veto_active = getattr(config, 'MULTITIMEFRAME_VETO_ENABLED', True)
                            if not is_veto_active and regime == "TRENDING":
                                print(f"  [REGIME VETO] Strong trend detected ({regime}). Temporarily enabling HTF Trend Veto.")
                                is_veto_active = True
